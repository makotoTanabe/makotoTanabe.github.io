...
const Persona = [
    ["加藤 和馬","・いつも冷静に周囲を見渡すことが得意です。","・プレゼン力も高く、自分の考えを正しく伝える力が高いと思われます。",["./reportImage/max2.png","./reportImage/max1.png"][(skill[0]>30)*1]],
    ["西村 明彦","・人間力が非常に高いです。","・プログラミングも非常に強い傾向で、Pythonマスターと呼ばれます。","./reportImage/akihikosan.png"],
    ["國代 京香","・行動力に非常にすぐれています。","・持ち前の行動力を活かし、企画業務で強みを発揮できます。","./reportImage/kyouka.png"],
];
// 人に合わせて文字色を変更
if (no === 0){
